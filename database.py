...
# data = get_data_function("01-04-2024", "31-03-2025","2425",1)
# print(data)
...
def stored_data(doc_id, aggregated_data) :
    ...
    collection = db["users"]
    trade_summary_list = [{"date": date, **details} for date, details in aggregated_data.items()]
...
def stored_datas(user_id,access_token) :
    starting_trading_date = "20-01-2022"
